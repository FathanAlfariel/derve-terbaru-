    ...
    <x-auth-card-register>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-text-input id="name" class="block mt-1 py-2 text-sm w-full" type="text" name="name" :value="old('name')" required autofocus />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="email" class="block mt-1 py-2 text-sm w-full" type="email" name="email" :value="old('email')" required />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="password_confirmation" class="block mt-1 py-2 text-sm w-full"
                                type="password"
