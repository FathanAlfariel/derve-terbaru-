        ...
        <div class="dropdown">
          ...
          <div class="dropdown-content dropdown-toko rounded-lg" style="background: white; min-width: 400px; right: -100px;">
            ...
            <div class="py-1.5 flex justify-center">
              <a href="/seller" target="_blank" type="button" class="py-1.5 px-3 w-full mx-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
      ...
      <form>
        <div class="flex">
            <div class="relative w-full">
                <input type="search" id="search-dropdown" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-l-lg rounded-r-lg border-l-gray-50 border-l-2 border border-gray-300 focus:ring focus:ring-blue-700/50 focus:border-blue-500 dark:bg-gray-700 dark:border-l-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="" required>
